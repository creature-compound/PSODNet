...
def fastrcnn_loss(class_logits, box_regression, labels, regression_targets):
    ...
    class_loss_type='label_smoothing_loss'

    if class_loss_type=='label_smoothing_loss':
        classification_loss = label_smoothing_loss(class_logits, labels)
    else:
...
def label_smoothing_loss(class_logits, labels, smoothing: float = 0.3) :

    confidence = 1.0 - smoothing
    logprobs = F.log_softmax(class_logits, dim=-1)
